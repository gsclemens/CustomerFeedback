...
namespace CustomerFeedback.Controllers
{
    public class SurveysController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,CreatedDate,ExpireDate,AdministratorId")] Survey survey)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,CreatedDate,ExpireDate,AdministratorId")] Survey survey)
        {
            if (id != survey.Id)
            {
                return NotFound();
